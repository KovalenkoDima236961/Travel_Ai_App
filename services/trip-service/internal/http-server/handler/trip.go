...
func (h *Handler) RegisterRoutes(r chi.Router) {
	...
	r.Post("/route-alternatives/sessions/{sessionId}/refine", h.gateFeature(featureflags.RouteAlternativesEnabled, h.RefineRouteAlternativeSession))
	r.Post("/route-alternatives/sessions/{sessionId}/alternatives/{alternativeId}/create-trip", h.gateFeature(featureflags.RouteAlternativesEnabled, h.CreateTripFromRouteAlternative))
	r.Route("/trips", func(r chi.Router) {
		...
		r.Get("/{id}", h.Get)
		r.Post("/{id}/export/archive", h.gateFeature(featureflags.DataExportsEnabled, h.CreateTripArchiveExport))
		...
		r.Post("/{id}/route/legs/{legId}/transport/search", h.gateFeature(featureflags.TransportSearchEnabled, h.SearchRouteLegTransportOptions))
		...
		r.Post("/{id}/route-alternatives", h.gateFeature(featureflags.RouteAlternativesEnabled, h.SuggestTripRouteAlternatives))
		r.Post("/{id}/route-alternatives/{sessionId}/alternatives/{alternativeId}/apply", h.gateFeature(featureflags.RouteAlternativesEnabled, h.ApplyRouteAlternative))
		r.Post("/{id}/route-alternatives/{sessionId}/create-poll", h.gateFeature(featureflags.RouteAlternativesEnabled, h.CreateRouteAlternativesPoll))
		...
		r.Post("/{id}/availability/import-calendar/preview", h.gateFeature(featureflags.CalendarSyncEnabled, h.PreviewCalendarAvailabilityImport))
		r.Post("/{id}/availability/import-calendar/apply", h.gateFeature(featureflags.CalendarSyncEnabled, h.ApplyCalendarAvailabilityImport))
		...
		r.Get("/{id}/expenses/export.csv", h.gateFeature(featureflags.DataExportsEnabled, h.ExportExpensesCSV))
		...
		r.Get("/{id}/expenses/receipts/export-metadata.csv", h.gateFeature(featureflags.DataExportsEnabled, h.ExportReceiptMetadataCSV))
		r.Get("/{id}/expenses/receipts/{receiptId}", h.GetReceipt)
		r.Get("/{id}/expenses/receipts/{receiptId}/file", h.GetReceiptFile)
		r.Post("/{id}/expenses/receipts/{receiptId}/extract", h.gateFeature(featureflags.ReceiptOCREnabled, h.ExtractReceipt))
		...
		r.Get("/{id}/settlements/export.csv", h.gateFeature(featureflags.DataExportsEnabled, h.ExportSettlementsCSV))
		...
		r.Get("/{id}/budget/export.csv", h.gateFeature(featureflags.DataExportsEnabled, h.ExportBudgetCSV))
		r.Get("/{id}/share", h.GetShare)
		r.Post("/{id}/share", h.gateFeature(featureflags.PublicSharingEnabled, h.CreateShare))
		r.Patch("/{id}/share", h.gateFeature(featureflags.PublicSharingEnabled, h.UpdateShare))
		...
		r.Get("/{id}/calendar-sync/google/status", h.gateFeature(featureflags.CalendarSyncEnabled, h.GetGoogleCalendarSyncStatus))
		r.Post("/{id}/calendar-sync/google/sync", h.gateFeature(featureflags.CalendarSyncEnabled, h.SyncGoogleCalendar))
		r.Delete("/{id}/calendar-sync/google", h.gateFeature(featureflags.CalendarSyncEnabled, h.RemoveGoogleCalendarSync))
		...
		r.Post("/{id}/generate", h.gateFeature(featureflags.AIGenerationEnabled, h.Generate))
		r.Post("/{id}/generation-jobs", h.gateFeature(featureflags.AIGenerationEnabled, h.CreateGenerationJob))
		...
		r.Post("/{id}/repair-jobs", h.gateFeature(featureflags.AIRepairEnabled, h.gateFeature(featureflags.PolicyRepairEnabled, h.CreateTripRepairJob)))
		...
		r.Post("/{id}/repair-proposals/{proposalId}/apply", h.gateFeature(featureflags.AIRepairEnabled, h.gateFeature(featureflags.PolicyRepairEnabled, h.ApplyTripRepairProposal)))
		r.Post("/{id}/repair-proposals/{proposalId}/discard", h.gateFeature(featureflags.AIRepairEnabled, h.gateFeature(featureflags.PolicyRepairEnabled, h.DiscardTripRepairProposal)))
		...
		r.Post("/{id}/approval/submit", h.gateFeature(featureflags.WorkspaceApprovalsEnabled, h.SubmitApproval))
		r.Post("/{id}/approval/approve", h.gateFeature(featureflags.WorkspaceApprovalsEnabled, h.ApproveTrip))
		r.Post("/{id}/approval/request-changes", h.gateFeature(featureflags.WorkspaceApprovalsEnabled, h.RequestTripChanges))
		r.Post("/{id}/approval/cancel", h.gateFeature(featureflags.WorkspaceApprovalsEnabled, h.CancelApproval))
	...
	r.Route("/trip-templates", func(r chi.Router) {
		...
		r.Post("/{templateId}/adaptation-jobs", h.gateFeature(featureflags.TemplateAdaptationEnabled, h.CreateTemplateAdaptationJob))
	})
...
func (h *Handler) RegisterInternalRoutes(r chi.Router) {
	...
	r.Post("/internal/feature-flags/evaluate", h.InternalEvaluateFeatureFlag)
}
