...
// TokenValidator validates Auth Service HS256 access tokens locally.
type TokenValidator struct {
	secret []byte
	now    func() time.Time
}

// NewTokenValidator creates a validator for Auth Service access tokens.
...
// ValidateAccessToken validates signature and expiry, then extracts user claims.
