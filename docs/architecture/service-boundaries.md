...
| Trip | Trips, revisions, shares, collaborators, invitations, comments, suggestions, votes, presence, jobs, budgets, receipts, policies, feature state, alpha invites/waitlist/participants, product analytics events, feedback, weekly alpha reports | Identity/profile canonical data, notification delivery, provider credentials | User, Notification, External, AI, RabbitMQ; called by Web/Worker | `/trips/*`, `/trip-templates/*`, `/alpha/*`, `/analytics/events`, `/feedback`, public shares and ops. Revision-sensitive writes need `expectedItineraryRevision`; enforce trip/workspace permissions. |
