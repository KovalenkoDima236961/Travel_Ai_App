...
import { useCreateTemplateAdaptationJob } from "@/hooks/useCreateTemplateAdaptationJob";
import { useTemplateAdaptationJob } from "@/hooks/useTemplateAdaptationJob";
...
function AdaptationJobStatus({
  ...
  summary: import("@/types/template-adaptation").TemplateAdaptationSummary | null;
