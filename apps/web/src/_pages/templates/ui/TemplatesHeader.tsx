...
/**
 * Redesigned app chrome for the Templates screen. Ships with the slice (AppHeader
 * is suppressed for `/templates`) so the warm palette does not leak onto the app
 * pages that still render the old slate header. Mirrors CreateTripHeader — no
 * scope picker / CTA — with the "Templates" nav item marked active.
 */
