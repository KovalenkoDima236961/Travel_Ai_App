...
/**
 * Redesigned app chrome for the Create Trip screen. Ships with the slice
 * (AppHeader is suppressed for `/trips/new`) so the warm palette does not leak
 * onto the app pages that still render the old slate header. Mirrors TripsHeader
