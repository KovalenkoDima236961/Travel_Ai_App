...
/**
 * Redesigned app chrome for the Workspace Detail screen. It ships with the slice
 * (AppHeader is suppressed for `/workspaces/[id]`) so the warm palette does not
 * leak onto the app pages that still render the old slate header. Mirrors
 * WorkspacesHeader: Workspaces nav active, no ScopeSelect, no header CTA — the
 * primary actions ("Settings", "New trip") live in the page hero/content.
 */
